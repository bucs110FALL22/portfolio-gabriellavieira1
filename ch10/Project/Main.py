...
def main():
  ...
  pygame.display.set_caption("Grow Your Garden")
  flower = pygame.image.load('Photos/Flower Icon.png')
  pygame.display.set_icon(flower)

  flower_1 = pygame.image.load('Photos/Flower 4.png')
  flower_1x= 200
  flower_1y= 280

  flower_2 = pygame.image.load('Photos/Flower 5.png')
  flower_2x=-20
  flower_2y=280

  flower_3 = pygame.image.load('Photos/Flower 6.png')
  flower_3x=420
  flower_3y= 280
  ...
  start=pygame.image.load('Photos/Bee.png').convert_alpha()
  ...
  while running:
        ...
        if pygame.mouse.get_pressed()[0] ==0:
              bee.clicked= False
        screen.blit(bee.image, (bee.rect.x, bee.rect.y))   #surface?
...
def welcome():
  ...
  while running:
      ...
      butterfly_1=pygame.image.load('Photos/butterfly.png').convert_alpha()
      butterfly1= butterfly.Butterfly(580,0 , butterfly_1, 0.8)

      #write_1=pygame.image.load('Photos/write.png').convert_alpha()
      #write1= write.Write(0,130 , write_1, 0.8)
      write1 = pygame.image.load('Photos/write.png')
      write_1x=0
      write_1y= 130
      ...
      #if write1.rect.collidepoint(pos):
      #      if pygame.mouse.get_pressed()[0]==1 and write1.clicked == False:
       #       write1.clicked= True
      ...
      #screen.blit(write1.image, (write1.rect.x, write1.rect.y))
...
def question():
    ...
    while running:
        ...
        flower_4=pygame.image.load('Photos/flowbut1.png').convert_alpha()
        flower4=habit.Habit(50,270 , flower_4, 0.8)

        flower_5=pygame.image.load('Photos/lotus .png').convert_alpha()
        flower5=choice.Choice(205,270 , flower_5, 0.8)

        flower_6=pygame.image.load('Photos/flowerbut_3.png').convert_alpha()
        flower6=option.Option(360,270 , flower_6, 0.8)

        flower_7=pygame.image.load('Photos/rose (1).png').convert_alpha()
        flower7=choose.Choose(515,270 , flower_7, 0.8)

        flower_8=pygame.image.load('Photos/flower.resources.png').convert_alpha()
        flower8=resource.Resource(400,400 , flower_8, 0.8)

       # draw = pygame.image.load('Photos/ladybug.png').convert_alpha()
       # ladybug1 = ladybug.Ladybug(580, 0, draw, 0.8)
        ...
        while action:
         ...
         # elif ladybug1.rect.collidepoint(pos):
...
def habit1():
  ...
  while movement:
    ...
    yes_button=pygame.image.load('Photos/yes(1).png').convert_alpha()
    yes1=yes.Yes(95,135 , yes_button, 0.8)

    font_10 = pygame.font.Font(None, 35)
    text_10 = font_10.render("Yes",True,text_color)
    screen.blit(text_10, (100,240))
    

    no_button=pygame.image.load('Photos/no(1).png').convert_alpha()
    no1=no.No(455,135 , no_button, 0.8)

    font_11 = pygame.font.Font(None, 35)
    text_11 = font_11.render("No",True,text_color)
